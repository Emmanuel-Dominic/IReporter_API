...
def get_password(password):
    ...
    if len(data["password"]) < 6:
        return (
            jsonify({"message": "Password must be atleast six characters or more"}),
            406,
        )
...
def verify_login_data(func):
    ...
    def wrapper(*args, **kwargs):
        if not request.data:
            return (
                jsonify(
                    {"message": "Please provide data", "example": example_login_data}
                ),
                400,
            )
        ...
        try:
            ...
            return (
                jsonify({"message": invalid_key_msg, "example": example_login_data}),
                400,
            )
...
def verify_signup_data(func):
    ...
    def wrapper(*args, **kwargs):
        if not request.data:
            return jsonify(
                    {"message": "Please provide data", "example": example_signup_data}
                ),400
        ...
        try:
            ...
            if not data["firstName"].isalpha():
                return (
                    jsonify({"message": "{} at firstName".format(Invalid_value_msg)}),
                    406,
                )
            if not data["lastName"].isalpha():
                return (
                    jsonify({"message": "{} at lastName".format(Invalid_value_msg)}),
                    406,
                )
            ...
            return (
                jsonify(
                    {
                        "message": "Please provide valid field for string data",
                        "example": example_signup_data,
                    }
                ),
                400,
            )
            ...
            return (
                jsonify(
                    {
                        "message": "Please provide valid data type for fields",
                        "example": example_signup_data,
                    }
                ),
                406,
        ...
        try:
            ...
            return (
                jsonify({"message": invalid_key_msg, "example": example_signup_data}),
                400,
            )
